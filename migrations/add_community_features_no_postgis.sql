...
-- Version WITHOUT PostGIS (removed the spatial index)
...
-- Simple lat/lng index instead of PostGIS
CREATE INDEX IF NOT EXISTS idx_reports_lat_lng ON public.reports(lat, lng) WHERE lat IS NOT NULL AND lng IS NOT NULL;
